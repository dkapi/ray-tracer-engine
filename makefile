...
# Source files
SRC = main.c vec3.c ray.c hittable.c sphere.c triangle.c darray/d_array.c interval.c camera.c color.c material.c aabb.c bvh.c raster.c textures/texture.c
